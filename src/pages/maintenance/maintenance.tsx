    ...
    <>
        ...
        <div className="row pt-15">
          <div className="col">
            <p className="normal2 text-center">
              기업의 업무에 사용되는 통신 장비 및 전산기기는 성능유지와 장애발생에 대비한<br/>
              지속적인 관리가 필요합니다. <br/>
              사무실마다 업무지원 담당자나 전산팀이 있지만 종류가 다른 모든 기기를 직접 관리하기란 사실상 어려우며,<br/>
              특히 통신분야는 더욱이 전문분야이므로 통신유지보수 전문기업에 맡기는 것이 <br/>
      ...
      <section className="container-fluid bg-gray-100">
        <div className="container pt-17 pb-22">
          ...
          <div className="row">
            <div className={clsx(styles['service-wrapper'], styles['service-1'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
                긴급<br/>장애처리
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-2'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
              랜공사<br/>통신공사
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-3'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
              프리미엄<br/>와이파이<br/>구축
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-4'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
              통신망<br/>분리
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-5'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
              서버랙 구축<br/>서버 관리
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-6'], 'col col-sm-6 col-md-3 col-lg-1')}>
              <p className="heading4 text-center white">
              VPN/UTM<br/>보안장비<br/>구축 및 관리
              </p>
            </div>
            <div className={clsx(styles['service-wrapper'], styles['service-7'], 'col col-md-6 col-lg-1')}>
              <p className="heading4 text-center white">
              네트워크<br/>유지보수
              </p>
            </div>
