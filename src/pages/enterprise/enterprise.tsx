...
import IconAccounting from "assets/images/icon/icon-accounting.svg";
import IconCloudBroadcasting from "assets/images/icon/icon-cloud-broadcasting.svg";
import IconMagneticCard from "assets/images/icon/icon-magnetic-card.svg";
import IconMonitor from "assets/images/icon/icon-monitor.svg";
        ...
        <div className="row flex-between">
          <div className="col col-sm-6 col-lg-3">
            <div className={styles['round-wrapper']}>
              ...
              <p className="mb-3 heading6 blue-100">PC대수 무제한</p>
              <p className="mb-1 gray-500">· 회선당 추가단말</p>
          ...
          <div className="col col-sm-6 col-lg-3">
            <div className={clsx(styles['round-wrapper'], styles['round-blue'])}>
              ...
              <p className="mb-3 heading6 white">저렴한 이용요금</p>
              <p className="mb-1 gray-200">최저 요금으로</p>
          ...
          <div className="col col-sm-6 col-lg-3">
            <div className={styles['round-wrapper']}>
              ...
              <p className="mb-3 heading6 blue-100">최적의 인터넷속도</p>
              <p className="mb-1 gray-500">사업 환경에 맞는</p>
          ...
          <div className="col col-sm-6 col-lg-3">
            <div className={clsx(styles['round-wrapper'], styles['round-blue'])}>
              ...
              <p className="mb-3 heading6 white">맞춤형 컨설팅 제공</p>
              <p className="mb-1 gray-200">상담부터 가입까지</p>
